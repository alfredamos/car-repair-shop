  ...
  return (
    <Form {...form}>
      <form
        ...
        className="bg-gray-50 dark:text-black dark:bg-black text-slate-800 max-w-sm items-center mx-auto rounded-xl shadow-2xl py-6 px-10 mt-10"
      >
        ...
        <div className="flex flex-col md:flex-row gap-2">
          <div className="flex flex-col">
            <InputWithLabel<EditUserProfile>
              fieldTitle="Name"
              type="text"
              nameInSchema="name"
          ...
          <div className="flex flex-col">
            <InputWithLabel<EditUserProfile>
              ...
              readOnly
            />
            <SelectWithLabel<EditUserProfile>
              fieldTitle="Gender"
              nameInSchema="gender"
              data={[
                { id: "Male", value: "Male" },
              ...
              className="mb-2 w-full dark:text-white"
            />
            <InputWithLabel<EditUserProfile>
              fieldTitle="Image"
              type="text"
