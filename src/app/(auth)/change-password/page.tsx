...
export default async function ChangeUserPasswordPage(){
    ...
    if (response instanceof CustomError) {
        return <div className="h-dvh flex justify-center items-center"><h1 className="font-bold p-10 bg-red-200 ring-1 ring-red-200 rounded-lg shadow-lg">{response?.message}</h1></div>
    }
