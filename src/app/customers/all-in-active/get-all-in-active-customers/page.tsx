import {getAllInActiveCustomers} from "@/app/actions/customer.action";
import {CustomError} from "@/utils/customError.util";
import CustomerTable from "@/app/customers/CustomerTable";

export default async function GetAllInActiveCustomersPage() {
    //----> Fetch all customers.
    const response = await getAllInActiveCustomers();
